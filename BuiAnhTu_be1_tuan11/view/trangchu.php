...
if (isset($_SESSION['login_success'])) {
    echo '<div class="alert alert-success">Chào mừng user ' . $_SESSION['login_success'] . ' đã đăng nhập</div>';
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h4 class="card-title"><a
                                        href="../view/chitietSP.php?ma=<?php echo $value->ma ?>"><?php echo $value->ten ?></a>
                                </h4>
                                ...
                                ?>
                                <p class="card-text"><?php echo $mota ?><a
                                        href="../view/chitietSP.php?ma=<?php echo $value->ma ?>">[...]</a></p>
                                <a href="../controller/themGioHang.php?ma=<?php echo $value->ma ?>"><input type="button"
                                        class="btn btn-primary" value="Thêm vào giỏ"></a>
                            </div>
                        </div>
                    </div>
